#!/usr/bin/env python3
"""
HockeyROI - Anton Forsberg cover card (16:9, 1200x675px)
...
IMG_PATH = os.path.join(BASE, "Covers", "Foresberg.jpg")
OUT_PATH = os.path.join(BASE, "Goalies All", "Forsberg", "Images", "forsberg_cover.png")
...
ax.text(tx, 415, 'ANTON', color=WHITE, fontsize=42,
        fontname=BEBAS, fontweight='bold', va='center', zorder=6)
ax.text(tx, 315, 'FORSBERG', color=WHITE, fontsize=42,
        fontname=BEBAS, fontweight='bold', va='center', zorder=6)
...
ax.text(tx, 165, 'Career Sample  |  All Situations  |  3 Seasons',
